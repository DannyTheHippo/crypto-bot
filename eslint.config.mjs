...
export default tseslint.config(
  {
    ignores: [
      ...
      // Same class: the long-only overlay study — bare .mjs run via `node`
      // (self-contained, reads only cached JSON, no src/ imports), outside any tsconfig project.
      'test/backtest/longonly-study.mjs',
      ...
      'test/features/common/scripts/loop-oos-transcript-core.spec.mjs',
