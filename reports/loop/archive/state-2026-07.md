# Daily profitability loop — archived state (2026-07)

Append-only historical record. These blocks were MOVED VERBATIM out of `reports/loop/state.md`
on 2026-07-20 (Y4 state hygiene) so the live state file holds current working state only.
Nothing here was rewritten; git history is the second copy. The provenance list also lives at
the foot of `state.md`.

## Provenance

- Push II program (owner session 2026-07-13) — 7/8 phases shipped; superseded by the v2 contract.
- Push 3 completion records (2026-07-14) — P7c/P7d/P7e/P7f/P8a/P8d; superseded by v2 + the phantom-position resolution and X2.
- v2 contract cutover (2026-07-18), Round-8 cleanup + W4 audit (2026-07-18/19), Y-series creation record (2026-07-19) — superseded by the 2026-07-20 A0 re-baseline and shipped Y1-Y4.
- Last pass narrative (Passes 23-34) — per-pass detail also in LOG.md.
- Backlog closed ledger (retired IDs) and the Resolved provenance index — historical pointers; detail in LOG.md by date.
