...
- **Alerting was dead since first boot** (2026-07-07 Pass 6, FIXED same pass): alerts.rules.yml
  ...
  steady state until #24 splits the counter by class.
