...
export function dailyLossTripped(sodEquityUtc: Decimal, equity: Decimal, maxDailyLoss: string): boolean {
...
export function drawdownTripped(peakEquity: Decimal, equity: Decimal, maxDrawdownPct: string): boolean {
