...
// persistence (modules/* zones may not cross-import — eslint-plugin-boundaries). Mirrors the app.module
...
// validator-rejection tripwire without this module importing modules/observability (boundary wall).
