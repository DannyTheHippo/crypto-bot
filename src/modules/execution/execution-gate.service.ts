...
// vetoes are counted by risk_rejections_total in RiskModule (eslint-boundaries forbids modules/risk
// importing modules/execution, so the taxonomy's risk stage lives in a sibling metric by design).
