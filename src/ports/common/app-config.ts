...
export interface AppConfig {
  ...
  agentic: {
    ...
    // Phase 4 (Profitability Edge Program): tournament-derived systematic edge policy — off by
    // default. When false, DisabledEdgePolicy is bound and runtime behavior is byte-identical.
    edgePolicyEnabled: boolean;
  ...
  risk: {
    ...
    // notional = cappedEquity × fraction / Signal.stopLossPct. Schema default '0' disables.
    maxPlannedStopRiskFraction: string;
