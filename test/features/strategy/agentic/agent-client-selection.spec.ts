...
import {
  ...
  SEED_PLAYBOOK_V3,
  selectAgentClient,
} from '../../../../src/features/strategy/agentic/agentic-strategy.module';
import { AnthropicAgentClient } from '../../../../src/features/strategy/agentic/anthropic-agent-client';
import { BatchingAgentClient } from '../../../../src/features/strategy/agentic/batching-agent-client';
import {
  MAX_PLAYBOOK_CHARS,
  validatePlaybook,
} from '../../../../src/features/strategy/agentic/playbook-validator';
import type {
  AgentDecisionInput,
  AgentMarketSnapshot,
