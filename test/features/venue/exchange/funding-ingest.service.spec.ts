...
import { FundingIngestService } from '../../../../src/features/venue/exchange/funding-ingest.service';
import type { ExchangePort, VenueFundingPayment } from '../../../../src/ports/venue/exchange';
import type {
  FundingPaymentRow,
  FundingPaymentsPort,
} from '../../../../src/ports/venue/funding-payments';
import type { ClockPort } from '../../../../src/ports/common/clock';
import { symbolId, venueId, epochMs } from '../../../../src/domain/common/types/ids';
